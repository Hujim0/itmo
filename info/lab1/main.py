...
if __name__ == '__main__':
    ...
    print("Дополнительное задание: \nперести число из системы счистления фибоначчи в десятичную")

    inp = input("Введите число: ")
    print(change_notation(inp, "fib", 10))

    print("Выберите число, его систему счистления и новую систему счистления")
    while True:
        print("Новое число:",
              change_notation(input("Ваше число: (пр. 123, 43.05, AA.FF) "),
                              input("Система счистления числа: (пр. 10, 2, fib, fact, berg) "),
                              input("Новая система счистления: (пр. 10, 2, fib, fact) ")))